<template>
  <perfect-scrollbar>
    <div class="box Select">
      <div class="UpMu">
        <!--菜单-->
        <ManageUp @pushFlag="ChangeFlag" :flag="flag"></ManageUp>
      </div>
...
<script>
import ManageUp from "@/components/common/ManageUp.vue";
...
import ImageUpdateView from "@/components/common/ImageUpdateView.vue";
